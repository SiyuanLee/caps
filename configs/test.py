...
# is this the learning rate for q? what is the other two learning rate?
lr_multiplier = 1.0
...
dqn_config = {
    ...
    'frame_history_len': 4,  # source是不是需要和target一致
    'target_update_freq': 10000,
    'grad_norm_clipping': 10,
    'learning_rate': learning_rate,
    'exploration': exploration,
    'eval_obs_array': eval_obs_array,  # TODO: construct some eval_obs_array
    'room_q_interval': 1e3,  # q_vals will be evaluated every room_q_interval steps
    'epoch_size': 5e2,  # you decide any way
