...
learning_rate_term = PiecewiseSchedule([
    ...
    (num_iter / 20, 2e-3 * lr_multiplier),
    (num_iter / 5, 2e-3 * lr_multiplier),
    (num_iter / 2, 2e-3 * lr_multiplier),
    (num_iter * 3 / 4, 2e-3 * lr_multiplier),
], outside_value=2e-3 * lr_multiplier)
