...
source_dirs = [
    ...
    '/home/lsy/same_room5_12_12_17_21:00:29/dqn',
]
...
transfer_config = {
    ...
    'no_share_para': True  # default false (True means don't share parameter between q network and q_omega/term)
}
...
dqn_config = {
    ...
    'additional_wrapper': NoOpWrapperMK,  # this line represents training without noop action, otherwise comment it out
