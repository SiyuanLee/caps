# make epsilon drop faster compared to 12_22
#server
"""
...
# load the random sampled obs
# import pickle
# pkl_file = '/home/beeperman/Project/ple-monsterkong/examples/dqn_get_eval_obs/eval_obs_array_random_batch.pkl'
# with open(pkl_file, 'rb') as f:
#    eval_obs_array = pickle.loads(f.read())
...
transfer_config = {
    ...
    # 'xi': 0,                # default none you may specify a constant. none means xi = 0.5 (q_omega_val - q_omega_second_max)
