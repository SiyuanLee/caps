...
def learn(env,
    ...
    omega_t_ph = tf.placeholder(tf.int32, [None])
    ...
    # YOUR CODE HERE
    # Why reuse is false before?
    q_omega, beta, q_current = q_func(obs_t_float, num_actions, scope='q_func', reuse=False)
    # q_current = q_func(obs_t_float, num_actions, scope='q_func', reuse=False)
    _, _, q_target = q_func(obs_tp1_float, num_actions, scope='target_q_func', reuse=False)
    q_omega_next, beta_next, q_next_current = q_func(obs_tp1_float, num_actions, scope='q_func', reuse=True)
        ...
        if t % LOG_EVERY_N_STEPS == 0 and model_initialized:
            ...
            if t % room_q_interval == 0 and log_dir != None:
                ...
                if eval_obs_array:
                    ...
                    with open(log_dir + 'dqn/' + str(t) + "_q.pkl", 'wb') as f:
            ...
            if (t - learning_starts) % epoch_size == 0 and log_dir != None:
                ...
                # plt.savefig('evaluate/test_rewards.png')
